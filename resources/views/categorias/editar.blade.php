...
<header>
    <div class="mx-auto max-w-7x1 px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3x1 font-bold tracking-tight text-blue-900">Editar Registro de Categoría</h1>
    </div>
</header>
<!-- component -->
    ...
    <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
        <div class='max-w-md mx-auto space-y-6'>
            <form action="{{ route('categoria.update', $categoria->id) }}" method="POST">
                ...
                <input type="text" name="nombre" value="{{ $categoria->nombre }}" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none" required>
                <br>
